...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="ᴴᴱᴸᴾ",callback_data="help_back"),InlineKeyboardButton(text="ᶜʳᵉᵃᵗᵒʳ",url="https://t.me/rosebakthan")]]
    keyboard += [[InlineKeyboardButton(text="ᶜᵒⁿⁿᵉᶜᵗ ᴳʳᵒᵘᵖ", callback_data="main_connect"),InlineKeyboardButton(text="ᴬᴰᴰ ᴹᴱ",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="Contact Creator",url="https://t.me/rosebakthan")]]))
        return
